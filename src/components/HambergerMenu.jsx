...
export default function MiniDrawer() {
  ...
  return (
    <Box sx={{ display: "flex", direction: "ltr" }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} sx={{ direction: "ltr" }}>
        <Toolbar>
          <IconButton
            color="inherit"
        ...
        <List>
          <ListItem disablePadding sx={{ display: "block" }}>
            ...
            >
             ...
             <Link to={{pathname: "manage-page"}}>
                  <ListItemText primary={"کالاها"} sx={{ opacity: open ? 1 : 0 }} />
             </Link>
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding sx={{ display: "block" }}>
            ...
            >
              ...
              <Link to={{pathname: "manage-of-sp"}}>
                  <ListItemText primary={"موجودی‌ و قیمت‌ها"} sx={{ opacity: open ? 1 : 0 }} />
              </Link>
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding sx={{ display: "block" }}>
            ...
            >
              ...
              <Link to={{pathname: "order-page"}}>
                  <ListItemText primary={"سفارش‌ها"} sx={{ opacity: open ? 1 : 0 }} />
              </Link>
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding sx={{ display: "block" }}>
